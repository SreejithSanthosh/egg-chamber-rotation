...
for m = 0:M_nu-1
    ...
    for n=0:M_phi-1
        ...
        zArr_for = [zArr_for;R*cos(nu_m)];
        N_count = N_count+1;
    end
end

rPosCells = [xArr_for,yArr_for,zArr_for]';
zCutOff = cos(thetaS); logic = rPosCells(3,:)<zCutOff;
rPosCells = rPosCells(:,logic);
